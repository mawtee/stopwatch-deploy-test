...
# Script: stopwatchApp.py
# Authors: The Data Table (B. Cowley and M. Tibbles)
# Description:
...
# Set working directory (not needed once Git is up)
os.chdir("C:/Users/Matt/Documents/The Data Table/StopWatch")

#/////////////////////////////////////////////////////////////////////////////#

#=============================================================================#
#                      1. Formatting data for analysis                        #
#=============================================================================#

# 1.1. Stop and search data
# ================================

# Reading in data
df = pd.read_csv(r'source data\sample_police.csv')

# Create Datasets
allData = df.loc[:, ["Date", "Latitude", "Longitude", "Gender", "Age range", "Self-defined ethnicity", "Officer-defined ethnicity",
                     "Legislation", "Outcome", "Outcome linked to object of search", "Removal of more than just outer clothing"]]
baseData = df.loc[:, ["Date", "Officer-defined ethnicity", "Legislation"]]

# Assigning dummy values for legislation
baseData['Legislation Key'] = np.where(baseData.Legislation == "Police and Criminal Evidence Act 1984 (section 1)", 1,
                                       np.where(baseData.Legislation == "Firearms Act 1968 (section 47)", 2,
                                                np.where(baseData.Legislation == "Criminal Justice and Public Order Act 1994 (section 60)", 3,
                                                         np.where(baseData.Legislation == "Misuse of Drugs Act 1971 (section 23)", 4, 0))))
#print(baseData["Officer-defined ethnicity"].unique())
